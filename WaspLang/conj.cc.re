...
#line 37 "conj.cc.re" // lalr1.cc:404
...
#line 128 "conj.cc.re" // lalr1.cc:408
...
namespace yy {
#line 203 "conj.cc.re" // lalr1.cc:408
...
#line 1621 "conj.cc.re" // lalr1.cc:408
...
#line 1629 "conj.cc.re" // lalr1.cc:412
...
#line 1678 "conj.cc.re" // lalr1.cc:413
...
namespace yy {
#line 1764 "conj.cc.re" // lalr1.cc:479
...
#line 2343 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 2379 "conj.cc.re" // lalr1.cc:859
    break;

  case 39:
#line 182 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_comma(M(yystack_[0].value.as< expression > ())); }
#line 2385 "conj.cc.re" // lalr1.cc:859
    break;

  case 40:
#line 183 "GrammarConfig.y" // lalr1.cc:859
...
#line 2391 "conj.cc.re" // lalr1.cc:859
    break;

  case 41:
#line 184 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = ctx.def(yystack_[2].value.as< std::string > ()) %= M(yystack_[0].value.as< expression > ()); }
#line 2397 "conj.cc.re" // lalr1.cc:859
    break;

  case 42:
#line 185 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = ctx.def(yystack_[0].value.as< std::string > ()) %= 0l; }
#line 2403 "conj.cc.re" // lalr1.cc:859
    break;

  case 43:
#line 186 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = M(yystack_[0].value.as< expression > ()); }
#line 2409 "conj.cc.re" // lalr1.cc:859
    break;

  case 44:
#line 187 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = M(yystack_[0].value.as< expression > ()); }
#line 2415 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 2421 "conj.cc.re" // lalr1.cc:859
    break;

  case 46:
#line 189 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_comma(M(yystack_[0].value.as< expression > ())); }
#line 2427 "conj.cc.re" // lalr1.cc:859
    break;

  case 47:
#line 190 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = M(yystack_[2].value.as< expression > ()); yylhs.value.as< expression > ().params.push_back(M(yystack_[0].value.as< expression > ())); }
#line 2433 "conj.cc.re" // lalr1.cc:859
    break;

  case 48:
#line 191 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = yystack_[0].value.as< long > (); }
#line 2439 "conj.cc.re" // lalr1.cc:859
    break;

  case 49:
#line 192 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = M(yystack_[0].value.as< std::string > ()); }
#line 2445 "conj.cc.re" // lalr1.cc:859
    break;

  case 50:
#line 193 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = ctx.use(yystack_[0].value.as< std::string > ()); }
#line 2451 "conj.cc.re" // lalr1.cc:859
    break;

  case 51:
#line 194 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = M(yystack_[1].value.as< expression > ()); }
#line 2457 "conj.cc.re" // lalr1.cc:859
    break;

  case 52:
#line 195 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_deref(e_add(M(yystack_[3].value.as< expression > ()), M(yystack_[1].value.as< expression > ()))); }
#line 2463 "conj.cc.re" // lalr1.cc:859
    break;

  case 53:
#line 196 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_fcall(M(yystack_[2].value.as< expression > ())); }
#line 2469 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 2524 "conj.cc.re" // lalr1.cc:859
    break;

  case 63:
#line 204 "GrammarConfig.y" // lalr1.cc:859
    {yylhs.value.as< expression > ()=M(yystack_[2].value.as< expression > ());}
#line 2530 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 2537 "conj.cc.re" // lalr1.cc:859
    break;

  case 65:
#line 207 "GrammarConfig.y" // lalr1.cc:859
    {}
#line 2543 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 2550 "conj.cc.re" // lalr1.cc:859
    break;

  case 67:
#line 210 "GrammarConfig.y" // lalr1.cc:859
    {}
#line 2556 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 210 "GrammarConfig.y" // lalr1.cc:859
    { if (!yystack_[0].value.as< expression > ().is_pure()) { yylhs.value.as< expression > () = ctx.temp() %= e_addrof(M(yystack_[0].value.as< expression > ())); yystack_[0].value.as< expression > () = e_deref(yylhs.value.as< expression > ().params.back()); }
									yylhs.value.as< expression > () = e_comma(M(yylhs.value.as< expression > ()), M(yystack_[0].value.as< expression > ()) %= e_add(C(yystack_[0].value.as< expression > ()), -1l)); }
#line 2563 "conj.cc.re" // lalr1.cc:859
    break;

  case 69:
#line 213 "GrammarConfig.y" // lalr1.cc:859
...
#line 2570 "conj.cc.re" // lalr1.cc:859
    break;

  case 70:
#line 216 "GrammarConfig.y" // lalr1.cc:859
    { if (!yystack_[1].value.as< expression > ().is_pure()) { yylhs.value.as< expression > () = ctx.temp() %= e_addrof(M(yystack_[1].value.as< expression > ())); yystack_[1].value.as< expression > () = e_deref(yylhs.value.as< expression > ().params.back()); }
									auto i = ctx.temp(); yylhs.value.as< expression > () = e_comma(M(yylhs.value.as< expression > ()), C(i) %= C(yystack_[1].value.as< expression > ()), C(yystack_[1].value.as< expression > ()) %= e_add(C(yystack_[1].value.as< expression > ()), -1l), C(i)); }
#line 2577 "conj.cc.re" // lalr1.cc:859
    break;

  case 71:
#line 219 "GrammarConfig.y" // lalr1.cc:859
    {yylhs.value.as< expression > ()=M(yystack_[2].value.as< expression > ());}
#line 2583 "conj.cc.re" // lalr1.cc:859
    break;

  case 72:
#line 219 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_cor(M(yystack_[2].value.as< expression > ()), M(yystack_[0].value.as< expression > ())); }
#line 2589 "conj.cc.re" // lalr1.cc:859
    break;

  case 73:
#line 220 "GrammarConfig.y" // lalr1.cc:859
    {yylhs.value.as< expression > ()=M(yystack_[2].value.as< expression > ());}
#line 2595 "conj.cc.re" // lalr1.cc:859
    break;

  case 74:
#line 220 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_cand(M(yystack_[2].value.as< expression > ()), M(yystack_[0].value.as< expression > ())); }
#line 2601 "conj.cc.re" // lalr1.cc:859
    break;

  case 75:
#line 221 "GrammarConfig.y" // lalr1.cc:859
    {yylhs.value.as< expression > ()=M(yystack_[2].value.as< expression > ());}
#line 2607 "conj.cc.re" // lalr1.cc:859
    break;

  case 76:
#line 221 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_eq(M(yystack_[2].value.as< expression > ()), M(yystack_[0].value.as< expression > ())); }
#line 2613 "conj.cc.re" // lalr1.cc:859
    break;

  case 77:
#line 222 "GrammarConfig.y" // lalr1.cc:859
    {yylhs.value.as< expression > ()=M(yystack_[2].value.as< expression > ());}
#line 2619 "conj.cc.re" // lalr1.cc:859
    break;

  case 78:
#line 222 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_eq(e_eq(M(yystack_[2].value.as< expression > ()), M(yystack_[0].value.as< expression > ())), 0l); }
#line 2625 "conj.cc.re" // lalr1.cc:859
    break;

  case 79:
#line 223 "GrammarConfig.y" // lalr1.cc:859
    {}
#line 2631 "conj.cc.re" // lalr1.cc:859
    break;

  case 80:
#line 223 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_addrof(M(yystack_[0].value.as< expression > ())); }
#line 2637 "conj.cc.re" // lalr1.cc:859
    break;

  case 81:
#line 224 "GrammarConfig.y" // lalr1.cc:859
    {}
#line 2643 "conj.cc.re" // lalr1.cc:859
    break;

  case 82:
#line 224 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_deref(M(yystack_[0].value.as< expression > ())); }
#line 2649 "conj.cc.re" // lalr1.cc:859
    break;

  case 83:
#line 225 "GrammarConfig.y" // lalr1.cc:859
    {}
#line 2655 "conj.cc.re" // lalr1.cc:859
    break;

  case 84:
#line 225 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_neg(M(yystack_[0].value.as< expression > ())); }
#line 2661 "conj.cc.re" // lalr1.cc:859
    break;

  case 85:
#line 226 "GrammarConfig.y" // lalr1.cc:859
    {}
#line 2667 "conj.cc.re" // lalr1.cc:859
    break;

  case 86:
#line 226 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_eq(M(yystack_[0].value.as< expression > ()), 0l); }
#line 2673 "conj.cc.re" // lalr1.cc:859
    break;

  case 87:
#line 227 "GrammarConfig.y" // lalr1.cc:859
    {yylhs.value.as< expression > ()=M(yystack_[2].value.as< expression > ());}
#line 2679 "conj.cc.re" // lalr1.cc:859
    break;
...
#line 2686 "conj.cc.re" // lalr1.cc:859
    break;


#line 2690 "conj.cc.re" // lalr1.cc:859
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  conj_parser::yyrline_[] =
  {
     ...
     193,   194,   195,   196,   197,   198,   198,   199,   199,   200,
     200,   201,   201,   204,   204,   207,   207,   210,   210,   213,
     216,   219,   219,   220,   220,   221,   221,   222,   222,   223,
     223,   224,   224,   225,   225,   226,   226,   227,   227
  };
...
#line 3247 "conj.cc.re" // lalr1.cc:1167
#line 230 "GrammarConfig.y" // lalr1.cc:1168
