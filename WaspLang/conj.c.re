...
#line 37 "conj.c.re" // lalr1.cc:404
...
#line 128 "conj.c.re" // lalr1.cc:408
...
namespace yy {
#line 203 "conj.c.re" // lalr1.cc:408
...
#line 1596 "conj.c.re" // lalr1.cc:408
...
#line 1604 "conj.c.re" // lalr1.cc:412
...
#line 1653 "conj.c.re" // lalr1.cc:413
...
namespace yy {
#line 1739 "conj.c.re" // lalr1.cc:479
...
#line 2213 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2261 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2345 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2351 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2357 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2363 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2370 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2377 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2384 "conj.c.re" // lalr1.cc:859
    break;
...
#line 200 "GrammarConfig.y" // lalr1.cc:859
    { if (!yystack_[0].value.as< expression > ().is_pure()) { yylhs.value.as< expression > () = ctx.temp() %= e_addrof(M(yystack_[0].value.as< expression > ())); yystack_[0].value.as< expression > () = e_deref(yylhs.value.as< expression > ().params.back()); }
										  yylhs.value.as< expression > () = e_comma(M(yylhs.value.as< expression > ()), M(yystack_[0].value.as< expression > ()) %= e_add(C(yystack_[0].value.as< expression > ()), -1l)); }
#line 2391 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2398 "conj.c.re" // lalr1.cc:859
    break;
...
#line 206 "GrammarConfig.y" // lalr1.cc:859
    { if (!yystack_[1].value.as< expression > ().is_pure()) { yylhs.value.as< expression > () = ctx.temp() %= e_addrof(M(yystack_[1].value.as< expression > ())); yystack_[1].value.as< expression > () = e_deref(yylhs.value.as< expression > ().params.back()); }
										  auto i = ctx.temp(); yylhs.value.as< expression > () = e_comma(M(yylhs.value.as< expression > ()), C(i) %= C(yystack_[1].value.as< expression > ()), C(yystack_[1].value.as< expression > ()) %= e_add(C(yystack_[1].value.as< expression > ()), -1l), C(i)); }
#line 2405 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2411 "conj.c.re" // lalr1.cc:859
    break;

  case 46:
#line 211 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_cand(M(yystack_[2].value.as< expression > ()), M(yystack_[0].value.as< expression > ())); }
#line 2417 "conj.c.re" // lalr1.cc:859
    break;

  case 47:
#line 212 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_eq(M(yystack_[2].value.as< expression > ()), M(yystack_[0].value.as< expression > ())); }
#line 2423 "conj.c.re" // lalr1.cc:859
    break;
...
#line 2429 "conj.c.re" // lalr1.cc:859
    break;

  case 49:
#line 214 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_addrof(M(yystack_[0].value.as< expression > ())); }
#line 2435 "conj.c.re" // lalr1.cc:859
    break;

  case 50:
#line 215 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_deref(M(yystack_[0].value.as< expression > ())); }
#line 2441 "conj.c.re" // lalr1.cc:859
    break;

  case 51:
#line 216 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_neg(M(yystack_[0].value.as< expression > ())); }
#line 2447 "conj.c.re" // lalr1.cc:859
    break;

  case 52:
#line 217 "GrammarConfig.y" // lalr1.cc:859
    { yylhs.value.as< expression > () = e_eq(M(yystack_[0].value.as< expression > ()), 0l); }
#line 2453 "conj.c.re" // lalr1.cc:859
    break;


#line 2457 "conj.c.re" // lalr1.cc:859
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  conj_parser::yyrline_[] =
  {
     ...
     197,   200,   203,   206,   209,   210,   211,   212,   213,   214,
     215,   216,   217
  };
...
#line 2915 "conj.c.re" // lalr1.cc:1167
#line 218 "GrammarConfig.y" // lalr1.cc:1168
